...
| **Royal Jelly (≥ 0.75)** | 229,424 (55%) |
| **Honey (0.50–0.74)** | 125,140 (30%) |
| **Propolis (< 0.50)** | 62,572 (15%) |
...
|------|------------|-------|-------------|
| **Royal Jelly** | ≥ 0.75 | 229,424 | Production-ready. Full deed. This ships. |
| **Honey** | 0.50–0.74 | 125,140 | Usable. Improvable. Never discarded. |
| **Propolis** | < 0.50 | 62,572 | Intelligence. Reveals issues before production. |
